<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/UserSide.Master" AutoEventWireup="true" CodeBehind="DoctorLog.aspx.cs" Inherits="OSHCCSApp.UI.DoctorLog" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <asp:TextBox ID="txtDoctorUserName" runat="server" CssClass="form-control" placeholder="User Name"></asp:TextBox>
                            </div>
                            <div class="form-group">
